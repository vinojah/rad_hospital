  ...
  <div class="header">
    <div class="header-right">
     ...
     <div >
            ...
            <h1>Lab Reports</h1>
            <form action=" lab_report.jsp" method="POST">
                  
                  <div class="form-group">
                    <label class="control-label col-sm-3" for="id">Patient Id</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="pid" placeholder="Enter NIC Number " name="pid" required="required">
                    </div>
                  </div>
                  
                  <div class="form-group">
                      <label class="control-label col-sm-3" for="bno"  >Bill Number(Printed on bill):  </label>
                    <div class="col-sm-6">
