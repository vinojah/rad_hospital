         ...
         if(session.getAttribute("uname")!=null){
            ...
            <div class="container" style="background-color:#e6f2ff">
             ...
             <%
                    ...
                    String chanelno = request.getParameter("cno"); 
                    String doctorID = request.getParameter("doctorID");   
                    
try{
    Class.forName("com.mysql.jdbc.Driver");
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospitaldb", "root", "");
                    String query = "Select * from channeling where doctorID='"+session.getAttribute("doctorID")+"' and channelingNo='"+chanelno+"'";
                    Statement stmt = con.createStatement();
                    ...
                    while(rs.next())
                    {
                      ...
                      out.println("<tr>");
                        ...
                        out.println("<th><input type=text class=form-control value='"+rs.getString("patientName")+"' name = 'name'></th>");
                        out.println("</tr>");
                        out.println("<tr>");
                        
                        out.println("<th>Phone No</th>");
                        out.println("<th><input type=text class=form-control value='"+rs.getString("mobileNo")+"' name = 'phone'></th>");
                        out.println("</tr>");
                        out.println("<tr>");
                        
                         out.println("<th>Age</th>");
                        out.println("<th><input type=text class=form-control value='"+rs.getString("age")+"' name = 'age'></th>");
                        out.println("</tr>");
                        
                        out.println("<tr>");
                        
                        out.println("<th>Gender</th>");
                        out.println("<th><input type=text class=form-control value='"+rs.getString("gender")+"' name = 'gender'></th>");
                        out.println("</tr>");
                         out.println("<tr>");
                        ...
                        out.println("<th><input type=text class=form-control value='"+rs.getString("nic")+"' name = 'nic'></th>");
                        out.println("</tr>");
  ...
  out.println("</table>");
  out.println("<input type='submit' value='Submit'class=btn btn-default name='submit'>");
  out.println("</form>");
  out.println("</form>");
                     }
