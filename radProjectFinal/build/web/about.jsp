    ...
    <div class="header-right">
      ...
      <%
         if(session.getAttribute("uname")!=null){
          ...
          <div class=" row" style="column-count: 2 ;padding: 50px">  
             
                  <h2>About us</h2>
                  <p>The University Hospital Zurich (UHZ) is open to all patients every day and provides fundamental medical care and cutting-edge medicine in a central location in Zurich. We use our superior academic knowledge to treat a wide range of health issues, taking a personal touch and utilizing highly specialized and up-to-date research.

 

                      <br> <br><b>Broad and specialized range of services</b><br><br>
Each year, we treat around 42,000 inpatients and have over 500,000 outpatient visits at our 43 departments and institutes. Our employees guarantee comprehensive and individualized medical support even beyond their specific disciplines. With 980 hospital beds and close to 300,000 inpatient days, UHZ is one of the largest hospitals in Switzerland.
